(function (global, factory) {
  ...
  */
	function h(nodeName, attributes) {
		...
		var p = new VNode();
		p.nodeName = shortcuts[nodeName] ? shortcuts[nodeName] : nodeName;
		p.children = children;
 ...
 *	@param {String} nodeName
  ...
  */
	...
	var Label = function (Component$$1) {
		function Label(props, context) {
			...
			this._onClick = function () {
				this$1.setState({
					count: ++this$1.state.count
				});
			};
		}

		if (Component$$1) Label.__proto__ = Component$$1;
		Label.prototype = Object.create(Component$$1 && Component$$1.prototype);
		Label.prototype.constructor = Label;

		Label.prototype.render = function render() {
			return h('div', { onClick: this._onClick }, this.state.count);
		};
	...
	var App = function (Component$$1) {
		...
		App.prototype.render = function render() {
			return h('bi-label', null);
		};

		return App;
	}(Component);

	React.render(h(App, null), document.getElementById("app"));
});
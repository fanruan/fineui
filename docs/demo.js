...
BI.shortcut("demo.date_pane_widget", Demo.DatePane);Demo.Downlist = BI.inherit(BI.Widget, {
    props: {
...
BI.shortcut("demo.down_list", Demo.Downlist);Demo.DialogView = BI.inherit(BI.Widget, {
